...
//? CallBack Function
const checkFilter = DetailCourse.filter(function(course,index)
    {
        return course.duration > 2;
    }
)

const checkFind = DetailCourse.myFind(function(courses,index)
  {
...
const check = course.myReduce(function(total,number)
  {
      return total + number;
  })
